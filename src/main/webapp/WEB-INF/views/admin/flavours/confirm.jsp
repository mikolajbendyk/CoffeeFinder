    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                Czy na pewno chcesz usunąć ten smak?
                <br><br>
                <button><a href="<c:url value="/admin/flavours/delete/${param.id}"/>">Tak</a></button>
                <button><a href="<c:url value="/admin/flavours/all"/>">Nie</a></button>
