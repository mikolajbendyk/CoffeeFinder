        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Nuty smakowe</h1>
                ...
                <!-- Content Row -->
                    ...
                    <table>
                        ...
                        <tbody>
                        <c:forEach items="${flavours}" var="flavour" varStatus="loop">
                            <tr>
                                <td><c:out value="${loop.count}"/></td>
                                <td><c:out value="${flavour.name}"/></td>
                                <td><a href='<c:url value="/admin/flavours/edit/${flavour.id}"/>'>Edytuj</a> 
                                    <a href='<c:url value="/admin/flavours/confirm?id=${flavour.id}"/>'>Usuń</a></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
                    <div><br>
                    <button><a href='<c:url value="/admin/flavours/add"/>'>Dodaj smak</a></button></div>
