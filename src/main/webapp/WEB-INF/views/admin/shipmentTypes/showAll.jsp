        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <table>
                    ...
                    <tbody>
                    <c:forEach items="${shipmentTypes}" var="shipmentType" varStatus="loop">
                        <tr>
                            <td><c:out value="${loop.count}"/></td>
                            <td><c:out value="${shipmentType.name}"/></td>
                            <td><a href='<c:url value="/admin/shipment-types/edit/${shipmentType.id}"/>'>Edytuj</a> 
                                <a href='<c:url value="/admin/shipment-types/confirm?id=${shipmentType.id}"/>'>Usuń</a></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
