        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <table>
                    ...
                    <tbody>
                    <c:forEach items="${species}" var="species" varStatus="loop">
                        <tr>
                            <td><c:out value="${loop.count}"/></td>
                            <td><c:out value="${species.name}"/></td>
                            <td><a href='<c:url value="/admin/species/edit/${species.id}"/>'>Edytuj</a> 
                                <a href='<c:url value="/admin/species/confirm?id=${species.id}"/>'>Usuń</a></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
